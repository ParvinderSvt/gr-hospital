                ...
                <div class="brdcmb-wpr d-flx itm-cntr"><!-- Breadcrumb NavXT 6.6.0 -->
                    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Home."
                        ...
                        <meta property="position" content="1">
                            ...
                            property="item" typeof="WebPage" title="Go to Mission And Vision."
                            href="{{ url('/mission-vision') }}" class="post post-page"><span property="name">Mission And
                                Vision</span></a>
                </div>
                <h1 style="margin-top: 40px;color: #fff;" class="page-ttl d-flx itm-cntr jstfy-cntr">Mission And Vision
                </h1>
            </div>
        </div>
    </section>
