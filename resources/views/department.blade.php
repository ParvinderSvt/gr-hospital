...
<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Home." href="{{url('/')}}" class="home"><span property="name">Home</span></a><meta property="position" content="1"></span><span class="brdcmb-arrow"></span><span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to General Physician." href="{{url('/about-us')}}" class="post post-page"><span property="name">General Physician</span></a></div>



									<h1 style="    margin-top: 40px;
    color: #fff;" class="page-ttl d-flx itm-cntr jstfy-cntr">General Physician</h1>
...
<div class="row g-lg-5 g-3">
            <div class="col-md-7">
									<h3 class="page-sub-ttl">GR Hospital - General Physician</h3>
