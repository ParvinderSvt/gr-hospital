...
<!-- News Letter -->
  <section class="section contact-info-sec" style="     background: #f3f3f3;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="#">     
								...
								<div class="col-lg-12 d-flex">
                                    <div class="flex-fill">
										<div class="contact-info-details d-flex align-items-center">
											...
											<div>														
												<h4>Email Us</h4>
                                                <a href="tel:+1">dsgproperties@gmail.com</a>,
											</div>
										</div>
                                    </div>
                                </div>
								<div class="col-lg-12 d-flex">
                                    <div class="flex-fill">
										<div class="contact-info-details d-flex align-items-center">
											...
											<div>														
												<h4>Location</h4>
												<p>302 prateek centre , Sanjay place agra </p>
											</div>
										</div>
                                    </div>
                                </div>
