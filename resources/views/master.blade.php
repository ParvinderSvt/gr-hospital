...
<title>GR Hospital | Multispeciality Hospitals in India | GR Hospitals for all Your Healthcare Needs - GR Hospitals</title>
...
<meta property="og:title" content="GR Hospital | Multispeciality Hospitals in India | GR Hospitals for all Your Healthcare Needs - GR Hospitals" />
					...
					<div class="container d-flex flex-wrap">
						<ul class="nav">
							<li class="nav-item"><a href="" rel="nofollow"
									target="_blank" class="nav-link link-dark px-2" title="Follow Us On Facebook"><i
										...
										<ul id="menu-main-menu" class="navbar-nav me-auto mb-2 mb-lg-0">
											...
											<li id="tl_health_information"
												...
												<ul class="sub-menu">
													...
													<li id="Eye" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-275788">
														<a href="#0">Eye</a>
													</li>
													<li id="Dermatology" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-277848">
														<a href="#0">Dermatology</a>
													</li>
												</ul>
											</li>
...
@yield('content')
		...
		<script
			src="{{url('/assets/')}}/js/jquery-3.2.1.min.js"></script>
