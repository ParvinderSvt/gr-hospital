...
<head>
    ...
    <link rel="stylesheet" href="{{ config('app.url') }}assets/assets/fontawesome-free-6.2.0-web/css/all.min.css"><link rel="stylesheet" href="{{ config('app.url') }}assets/css/simple-lightbox.css">
          ...
          <ul class="dropdown-menu mega" aria-labelledby="navbarDropdownMenuLink">
            <li id="tl_diseases_and_conditions"
                                ...
                                <li id="tl_contact_us"
                                    ...
                                    <a href="{{ route('contact') }}" aria-haspopup="true"
