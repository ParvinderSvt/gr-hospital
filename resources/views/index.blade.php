        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card menu-card">
                        <div class="card-body">
                            <img src="{{ url('assets/images/robotic-surgery.png') }}" alt="Robotic Surgery Icon"
                                width="46">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                            ...
                            <div class="news_slide_wrap">
                                <div class="card pg-card">
                                    <a href="#"><img src="{{ Voyager::image($item->image) }}"
                                            class="card-img-top" alt="Doctors at GR Hospital."></a>
                                    <div class="card-body">
                    ...
                    <a href="#" class="text-warning fs-6">View All <i class="fa fa-long-arrow-right"></i></a>
                </div>
            </div>
