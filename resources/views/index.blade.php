...
<div id="carouselExample" class="carousel slide carousel-fade">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item h-100">
            <div class="herobanner-img position-relative h-100">
                <img src="{{url('assets/images/123123-compressed_0.jpg')}}" style="width:100%" alt="banner" class="jpdiv">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-lg-5 g-3">
            <div class="col-md-7">
                ...
                technologies, skilled healthcare professionals, and cutting-edge treatments to deliver optimal care. Patients benefit
                from coordinated care plans tailored to their individual needs, ensuring holistic treatment and recovery. Multispecialty
                hospitals often serve as hubs for medical research, innovation, and education, striving to improve healthcare outcomes
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/transplants.svg')}}"
                            alt="Transplants Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#">Transplants</a>
                        </h5>
                        <p class="card-text">Heart transplant, Lung transplant, Liver transplant, Kidney transplant, Pancreas
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/heart-rate.png')}}"
                            alt="Cardiology Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Cardiology</a>
                        </h5>
                        <p class="card-text">MitraClip, TAVR/TAVI, Minimally invasive cabg, Robotic min invasive cabg, Ecmo</p>
                        <a href="#0"
                            class="btn-link">View More </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/leg.png')}}"
                            alt="Orthopedics Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Orthopedics</a>
                        </h5>
                        <p class="card-text">Mako Robotic Knee Replacement, Spine Surgery, Excelsius GPS spine Robotic Surgery,
                            VBT</p>
                        <a href="#0"
                            class="btn-link">View More </a>
                    </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/robotic-surgery.png')}}"
                            alt="Robotic Surgery Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Robotic
                                Surgery</a></h5>
                        <p class="card-text">The precision and dexterity of robotic arms allow for more intricate movements, improved visualization, and enhanced</p>
                        <a href="#0"
                            class="btn-link">View More </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/mammography.png')}}"
                            alt="Diagnostics Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Diagnostics</a></h5>
                        <p class="card-text">640 Slice CT Angiogram, Brain and Spine Suite, Tru Beam STX with velocity</p>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/stomach.png')}}"
                            alt="Gastroenterology" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Gastroenterology</a></h5>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/radiology.png')}}"
                            alt="Interventional Radiology Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0">Interventional
                                Radiology</a></h5>
                        <p class="card-text">In IR, radiologists utilize various imaging modalities such as X-rays, ultrasound, CT scans, and MR</p>
                        <a href="#0" class="btn-link">View More
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card menu-card">
                    <div class="card-body">
                        <img src="{{url('assets/images/esophagus.png')}}"
                            alt="ENT Icon" width="46">
                        <h5 class="card-title mt-2"><a
                                href="#0specialities/ent-treatment/">ENT</a>
                        </h5>
                        <p class="card-text">Balance disorders, voice and swallowing disorders, thyroid disorders, and facial plastic</p>
                        <a href="#0specialities/ent-treatment/"
                            class="btn-link">View More </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-lg-5 g-3">
            <div class="col-md-7">
                ...
                <p>GR Hospitals offer comprehensive medical services, advanced technology, and specialized expertise under one roof. Quality
                of care, reputation, and accessibility are pivotal factors. Hospitals provide critical emergency care, surgical
                interventions, and chronic disease management. Patient-centered approaches, compassionate staff, and clear communication
                ...
                <div class="row g-xl-5 g-2 pt-lg-4 pt-2 pb-3 pb-lg-0 whygr">
                    <div class="col-md-6">
                        ...
                        <div>GR Hospital known for its high-quality patient care, which includes skilled healthcare professionals...</div>
                    </div>
                    <div class="col-md-6">
                        <i class="fa-solid fa-info ps-2 "></i>
                        <h4>Advanced Technology</h4>
                        <div>GR Hospital invest in advanced medical equipment and technology, including diagnostic imaging, robotic surgery...</div>
                    </div>
                    <div class="col-md-6">
                        <i class="fa-solid fa-tasks ps-2 "></i>
                        <h4>Patient-Centered Approach</h4>
                        <div>GR Hospital prioritize patient satisfaction and comfort by offering personalized care, compassionate support...</div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="row g-lg-5 scroll-items position-relative">
            ...
            <div class="col-md-4">
                <div class="text-center">
                    <p>Evergreen Hospital surpassed my expectations. The skilled staff, modern facilities, and personalized care made my
                    recovery smooth and comfortable. I felt supported every step of the way. I highly recommend Evergreen Hospital for
                    anyone seeking exceptional healthcare services.<br><small style="color: #ff9e9c;">Keashav, Agra</small></p>
            ...
            <div class="col-md-4">
                <div class="text-center">
                    <p>The care I received at GR Hospital exceeded my expectations. From the compassionate staff to the
                        state-of-the-art
                        facilities, every aspect of my experience was exceptional. They provided personalized attention and ensured
                        I felt
